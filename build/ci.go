...
import (
	...
	"github.com/awesome-chain/Xchain/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		...
		{
			Name:        "gttc",
			Description: "TTC Protocol CLI client.",
		},
		{
			Name:        "puppeth",
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/awesome-chain/Xchain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/awesome-chain/Xchain/mobile")
