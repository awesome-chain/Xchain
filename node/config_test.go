...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gttc.ipc", false, filepath.Join(os.TempDir(), "gttc.ipc")},
		{"data", "gttc.ipc", false, "data/gttc.ipc"},
		{"data", "./gttc.ipc", false, "./gttc.ipc"},
		{"data", "/gttc.ipc", false, "/gttc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gttc.ipc", true, `\\.\pipe\gttc.ipc`},
		{"data", "gttc.ipc", true, `\\.\pipe\gttc.ipc`},
		{"data", `\\.\pipe\gttc.ipc`, true, `\\.\pipe\gttc.ipc`},
	}
