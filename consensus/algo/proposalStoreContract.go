...
type proposalStoreContract struct{}

func (c proposalStoreContract) pre(p player, in event) (pre []error) {
	return nil
}

func (c proposalStoreContract) post(p player, in, out event) []error {
	return nil
}
