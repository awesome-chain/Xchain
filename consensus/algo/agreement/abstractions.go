...
type BlockValidator interface {
	...
	Validate(context.Context, Block) (ValidatedBlock, error)
}
...
type BlockFactory interface {
	...
	//AssembleProposal(basics.Round, period) (*proposal, *proposalValue, error
	AssembleProposal(vrfSK *vrf.PrivateKey, round basics.Round, per period, leger LedgerReader) (*proposal, *proposalValue, error)
}
