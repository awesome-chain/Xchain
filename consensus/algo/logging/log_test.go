...
func TestWithFieldsNewLogger(t *testing.T) {
	...
	a.Regexp("time=\".*\" level=info msg=ABCDEFG 1=4 2=testNew file=log_test.go function=github.com/awesome-chain/Xchain/consensus/algo/logging.TestWithFieldsNewLogger line=\\d+", bufNewLogger.String())
	a.NotRegexp("time=\".*\" level=info msg=ABCDEFG 1=4 2=test file=log_test.go function=github.com/awesome-chain/Xchain/consensus/algo/logging.TestWithFieldsNewLogger line=\\d+", bufNewLogger.String())
}
