...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your private network manager          |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new network down to the       |")
	fmt.Println("| genesis block, bootnodes, miners and ethstats servers     |")
	...
	log.Info("Administering network", "name", w.network)
