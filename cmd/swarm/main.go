...
import (
	...
	"github.com/awesome-chain/Xchain/cmd/utils"
	"github.com/awesome-chain/Xchain/common"
	"github.com/awesome-chain/Xchain/console"
	"github.com/awesome-chain/Xchain/crypto"
	"github.com/awesome-chain/Xchain/ethclient"
	"github.com/awesome-chain/Xchain/internal/debug"
	...
	"github.com/awesome-chain/Xchain/swarm"
	bzzapi "github.com/awesome-chain/Xchain/swarm/api"
	swarmmetrics "github.com/awesome-chain/Xchain/swarm/metrics"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.ttceco/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.ttceco/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.ttceco/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.ttceco/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
